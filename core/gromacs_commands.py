...
def append_gmx_mdrun(path_TPR, path_TRR, path_GRO, path_EDR, path_LOG, path_CPO, bVerbose=False, iN_threads=-1, iN_MPI_threads=1, pinstate=0, path_XTC=None, path_PULLX=None, path_PULLF=None, path_TRR_RERUN=None, bBondedGPU=False):
    command =       " mdrun"
...
def append_gmx_distance(path_input_XTC, path_input_TPR, path_input_NDX, path_output_XVG, begintime=-1):
    command =       " distance"
...
class GROMACSRunCommands:
    ...
    @staticmethod
    def MDRUN_RERUN(path_TPR, path_TRR, path_GRO, path_EDR, path_LOG, path_CPO, path_XTC, path_TRR_RERUN):
        return GROMACSRunCommands.__gmx() + append_gmx_mdrun(path_TPR, path_TRR, path_GRO, path_EDR, path_LOG, path_CPO, path_XTC=path_XTC, 
                                                             path_TRR_RERUN=path_TRR_RERUN,
                                                             bVerbose=CoreSettings.GMX_MDRUN_VERBOSE, iN_threads=CoreSettings.MDRUN_N_threads, iN_MPI_threads=CoreSettings.GMX_MDRUN_N_MPI_THREADS, pinstate=CoreSettings.GMX_MDRUN_PINSTATE,
                                                             bBondedGPU=False)
    ...
    @staticmethod
    def DISTANCE(path_XTC, path_TPR, path_NDX, path_output_XVG, begintime):
        return GROMACSRunCommands.__gmx() + append_gmx_distance(path_XTC, path_TPR, path_NDX, path_output_XVG, begintime)
