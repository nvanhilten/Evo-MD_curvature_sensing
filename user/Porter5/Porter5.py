...
os.system('%s -d %s -i %s -opsi %s.psi -cpu %d -n 3 -maxfilt 150000 -maxmem 4 -v 0' % (config['DEFAULT']['hhblits'], config['DEFAULT']['uniprot20'], filename, filename, args.cpu))
...
ssd = open(filename.replace(".seq", ".ssd"), "w")
ssd.write(str(length)+"\n")
